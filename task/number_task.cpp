...
void task_function::number()
	{
		Mat image = imread("./images/white_light\\bad\\02_58_21.jpg");
		imshow("original image", image);

		Mat contrast_increased = image * 1;
		//imshow("contrast increased image", contrast_increased);
		//imwrite("./images/white_light/contrast increased bad/23_54_38_1.jpg", contrast_increased);

		Mat contrast_decreased= image * 0.8;
		//imshow("contrast decreased image", contrast_decreased);
		//imwrite("./images/white_light/contrast decreased bad/23_54_38_2.jpg", contrast_decreased);
		...
		//imwrite("./images/white_light/sharpenned bad/23_54_38_5.jpg", sharpen_original);
		...
		//imwrite("./images/white_light/sharp_cont_incre_bad/23_54_38_3.jpg", sharpen_contast_increased);
		...
		//imwrite("./images/white_light/sharp_cont_decre_bad/23_54_38_4.jpg", sharp_contrast_decreased);
		waitKey(0);
