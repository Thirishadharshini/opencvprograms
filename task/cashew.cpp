...
void task_function::cashew() {
	
	//Mat img = imread("./images/Image_20240928105035759.bmp");
	//Mat img = imread("./images/Image_20240928105055674.bmp");
	//Mat img = imread("./images/Image_20240928105113924.bmp");
	Mat img = imread("./images/Image_20240928105123410.bmp");
	//Mat img = imread("./images/Image_20240928105004226.bmp");
	//Mat img = imread("./images/Image_20240928104919496.bmp");
